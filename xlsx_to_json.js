#!/usr/bin/env node
/**
 * Скрипт для конвертации XLSX файла в структурированный JSON файл.
 */
...
function xlsxToJson(inputFile, outputFile = null) {
    ...
    if (outputFile) {
        ...
        outputPath = path.join(inputPath.dir, `${inputPath.name}.json`);
    }
...
const inputFile = args[0] || 'orders.xlsx';
